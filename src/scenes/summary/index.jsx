...
const Summary = () => {
    ...
    const { date, maxConsumption, maxCurrentPeak, updateMaxConsuption, updateMaxCurrentPeak } = useContext(dateToggleContext);
    ...
    const handlePeakSubmit = () => {
        if (isNaN(peakCurrent) || peakCurrent <= 0) {
            ...
            updateMaxCurrentPeak(peakCurrent);
            console.log('Top peakCurrent:', peakCurrent);
        }
    }
    return (
        <Box m="20px">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Typography variant="h5" marginLeft={"-20px"} fontWeight="300" color={colors.greenAccent[400]}> {maxConsumption} </Typography>
                        <TextField
                            label="Enter Value"
                            variant="outlined"
                            margin="dense"
                    ...
                    >
                        ...
                        <Typography variant="h5"  fontWeight="300" color={colors.greenAccent[400]}> {maxCurrentPeak} </Typography>
                        <TextField
                            label="Enter Value"
                            variant="outlined"
                            margin="dense"
